...
class li3d(ThreeDScene):
    def construct(self):
        ...
        a3 = Vector(grid.c2p(1, 1, 1))
        x1 = ValueTracker(1)
        x1a3 = always_redraw(
            lambda: Vector(grid.c2p(x1.get_value(), x1.get_value(), x1.get_value()))
        )
        ...
        a3_def = MathTex(r"\vec{a}_3=\begin{bmatrix} 1 \\ 1 \\ 1 \end{bmatrix}").next_to(a2_def, RIGHT).scale(0.65)
